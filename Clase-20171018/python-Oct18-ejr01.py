...
# 3.
cant_juv_fem = len([ unSocio for unSocio in lista_socios
	if unSocio[categoria] == "Juvenil" and unSocio[sexo] == "Femenino" ])

# 4.
cant_min_mas_fut = len([ unSocio for unSocio in lista_socios
...
print("Total de socios con categoria Juvenil y genero Femenino:", cant_juv_fem)
print("Total de socios con categoria Mini, genero Masculino y deporte Futbol:", cant_min_mas_fut)
print("Total de socios con genero Femenino y deporte Hockey:", cant_fem_hoc)
print("Total de socios con categoria Mini y deporte Tenis:", cant_min_ten)
print("Total de socios con deporte Natacion:", cant_natacion)
print("Porcentaje de socios con deporte Natacion:", porcentaje_natacion,"%")
print("Porcentaje de socios con genero Femenino:", porcentaje_femeninos,"%")
